...
public:
  ...
  int8_t LStickX()
  {
    if (data.analog.stick.lx > -3 && data.analog.stick.lx < 3)
    {
      return 0;
    }
  ...
  int8_t LStickY()
  {
    if (data.analog.stick.ly > -3 && data.analog.stick.ly < 3)
    {
      return 0;
    }
    else
  ...
  int8_t RStickX()
  {
    if (data.analog.stick.rx > -3 && data.analog.stick.rx < 3)
    {
      return 0;
    }
    else
  ...
  int8_t RStickY()
  {
    if (data.analog.stick.ry > -3 && data.analog.stick.ry < 3)
    {
      return 0;
    }
    else
